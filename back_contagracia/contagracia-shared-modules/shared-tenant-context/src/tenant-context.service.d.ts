...
export declare class TenantContextService implements OnModuleDestroy {
     ...
     */
    getCompanyNit(companyId: string): Promise<string | null>;
    /**
     * Obtener datos de establishment de una company para templates DIAN
     */
    getCompanyEstablishmentData(companyId: string): Promise<{
        company_name: string;
        address: string;
        phone: string;
        email: string;
     ...
     */
    hasModule(companyId: string, moduleKey: string): Promise<boolean>;
    /**
