 ...
 */
export declare const TenantAnyPermission: (...actionKeys: string[]) => (target: any, key?: string, descriptor?: PropertyDescriptor) => PropertyDescriptor;
/**
 ...
 */
export declare const TenantAllPermissions: (...actionKeys: string[]) => (target: any, key?: string, descriptor?: PropertyDescriptor) => PropertyDescriptor;
