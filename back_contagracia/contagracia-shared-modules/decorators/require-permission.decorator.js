...
const TenantAnyPermission = (...actionKeys) => {
    return (target, key, descriptor) => {
        (0, common_1.SetMetadata)(exports.TENANT_PERMISSIONS_KEY, actionKeys)(target, key, descriptor);
        (0, common_1.SetMetadata)(exports.TENANT_PERMISSIONS_MODE_KEY, 'any')(target, key, descriptor);
        return descriptor;
    };
};
...
const TenantAllPermissions = (...actionKeys) => {
    return (target, key, descriptor) => {
        (0, common_1.SetMetadata)(exports.TENANT_PERMISSIONS_KEY, actionKeys)(target, key, descriptor);
        (0, common_1.SetMetadata)(exports.TENANT_PERMISSIONS_MODE_KEY, 'all')(target, key, descriptor);
        return descriptor;
    };
};
