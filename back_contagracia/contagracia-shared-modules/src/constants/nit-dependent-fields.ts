...
export const NIT_DEPENDENT_FIELDS = {
   ...
   * Agregar aquí cualquier campo nuevo que guarde rutas con NIT
   */
  master: [
    { table: 'Company', field: 'logo_url' },
    { table: 'Company', field: 'legal_rep_signature_url' },
    // TODO: Agregar más campos aquí cuando se creen (ej: company_stamp_url, invoice_template_url, etc.)
  ...
  tenant: [
    ...
    // TODO: Agregar más campos de tenant aquí cuando se creen
  ] as NitDependentField[],
};
