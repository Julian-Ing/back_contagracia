...
export default function NewBlogPostPage() {
  ...
  useEffect(() => {
    blogService.getTags().then(setAvailableTags).catch(() => {});
  }, []);
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Crear Nuevo Post</h1>
          <p className="text-gray-500 dark:text-gray-400">Escribe y publica un nuevo artículo en el blog</p>
        </div>
      </div>
      ...
      <div className="rounded-lg border border-gray-200 dark:border-slate-700 overflow-hidden">
        <div className="bg-gradient-to-r from-purple-600 to-pink-600 p-4">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">Nuevo Post</h2>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="border-2 border-dashed border-gray-300 dark:border-slate-600 rounded-lg p-6 text-center hover:border-slate-500 transition-colors">
                  {featuredImage ? (
                    ...
                    <div className="space-y-2">
                      ...
                      />
                      <label htmlFor="featured-image-upload" className="inline-block cursor-pointer">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-gray-500">Opcional: Se genera automáticamente si se deja vacío</p>
              </div>
            </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2 p-3 border border-gray-200 dark:border-slate-700 rounded-lg bg-gray-50 dark:bg-slate-800/50">
                    {availableTags.length === 0 ? (
                      <span className="text-sm text-gray-500">No hay tags creados aún</span>
                    ) : (
