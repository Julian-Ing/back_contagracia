...
export default function PublicFormPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-900">
        <div className="text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-4">Cargando formulario...</p>
        </div>
      </div>
    );
  }
  ...
  if (error && !form) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-900 px-4">
        <Card className="max-w-md w-full bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700">
          <CardHeader className="text-center">
            <AlertCircle className="h-12 w-12 text-red-500 mx-auto mb-4" />
            <CardTitle className="text-gray-900 dark:text-white">Formulario no encontrado</CardTitle>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-900 py-12 px-4">
      <Card className="max-w-2xl w-full bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700">
        <CardHeader>
          <CardTitle className="text-gray-900 dark:text-white">{form?.name}</CardTitle>
          {form?.description && (
